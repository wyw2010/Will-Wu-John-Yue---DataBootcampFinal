...
### Train/test split
Chronological: first **80% of months** for training, last **20%** held out.
...
### Key takeaways
- The baseline is already strong ⇒ APT is **highly autocorrelated**.
...
- **Seasonality:** average APT dips Jan→May, peaks in July, then declines.
...
- Predict at **weekly or daily** granularity for more training signal.
- Quantify tail-risk performance (separate metrics for high-APT months).
